...
UC-1: Планирование загруженности персонала:
...
вариант создания системы с нуля под свои нужды выглядит более актуальным и простым в реализации.

На нем и будут сконцентрированы дальнейшие ADR'ы.